...
[![Release](https://img.shields.io/badge/Release-v2.5.0-indigo?style=for-the-badge)](CHANGELOG.md)
...
3. **🎛️ Styled Segmented Control (`SegmentedControl.jsx`)**:
...
4. **🗂️ Styled Data Table & Pagination (`Table.jsx`)**:
...
5. **🪟 Styled Slide-Over Drawer (`Drawer.jsx`)**:
...
6. **📇 Styled Breadcrumb Navigation (`Breadcrumb.jsx`)**:
...
7. **🎛️ Styled Slider Range Control (`Slider.jsx`)**:
...
8. **🔔 Styled Alert Banner (`Alert.jsx`)**:
...
9. **📇 Styled Dropdown Select (`Select.jsx`)**:
