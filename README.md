...
[![Release](https://img.shields.io/badge/Release-v1.2.0-indigo?style=for-the-badge)](file:///C:/Users/marve/Desktop/AI-286-Builds/Build_54/CHANGELOG.md)
...
Featuring 7 theme-aware components (`Button`, `Tabs`, `Modal`, `Card`, `Badge`, `Switch`, `Input`), this UI kit allows developers to pass custom themes via `<ThemeProvider>` while dynamically computing surface colors, backdrop filters, and text contrast.
